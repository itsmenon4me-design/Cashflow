...
test.describe('Multi-currency reports & analytics (sw-unregister)', () => {
  ...
  test('Reports monthly and Analytics overview reflect active currency and API (sw-unregister)', async ({ page, request }) => {
    ...
    for (const cur of CURRENCIES) {
      ...
      // Unregister service workers to avoid install/activate races during reload/navigation
