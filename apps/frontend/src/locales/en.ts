export const enText = {
  ...
  accounts: {
    title: "Accounts",
    subtitle: "Manage all company financial accounts.",
    add: "Add Account",
  ...
  categories: {
    title: "Categories",
    subtitle: "Manage company transaction categories.",
    add: "Add Category",
  ...
  budgets: {
    title: "Budgets",
    subtitle: "Manage monthly budgets per expense category.",
    add: "Add Budget",
    count: "{count} budgets",
  ...
  savingGoals: {
    title: "Savings Goals",
    subtitle: "Manage savings targets and track progress.",
    add: "Add Goal",
    count: "{count} goals",
    target: "Target",
    collected: "Collected",
