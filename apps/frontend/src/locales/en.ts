export const enText = {
  ...
  activity: {
    ...
    login: "Login",
    logout: "Logout",
    refreshToken: "Session refreshed",
  ...
  transactions: {
    ...
    suggestionTitle: "Smart Category Suggestion",
    suggestionHint: "Request a category suggestion based on the current transaction details.",
    suggestionButton: "Suggest category",
    suggestionConfidenceLabel: "Confidence",
    suggestionConfidenceHigh: "High",
    suggestionConfidenceMedium: "Medium",
    suggestionConfidenceLow: "Low",
    suggestionAccept: "Accept suggestion",
    suggestionFailed: "Failed to fetch a category suggestion.",
    suggestionNoCategories: "Add categories before requesting a suggestion.",
  },
  accounts: {
    title: "Accounts",
    subtitle: "",
