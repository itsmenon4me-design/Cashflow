export const idText = {
  ...
  settingsPage: {
    ...
    tabGeneral: "Umum",
    tabGeneralSummary: "Tampilan & bahasa",
    tabAccount: "Akun",
    tabAccountSummary: "Profil & keamanan",
    tabFinanceBot: "Finance Bot",
    tabFinanceBotSummary: "Notifikasi & gaya bot",
    tabNotifications: "Notifikasi",
    tabNotificationsSummary: "Pengaturan pemberitahuan",
    tabAbout: "Tentang",
    tabAboutSummary: "Info aplikasi",
    versionLabel: "Versi",
  },
  dashboard: {
  ...
  transactions: {
    ...
    subtitle: "Lihat dan cari seluruh histori transaksi keuangan Anda.",
