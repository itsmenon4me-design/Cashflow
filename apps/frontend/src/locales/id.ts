export const idText = {
  ...
  accounts: {
    title: "Akun",
    subtitle: "Kelola seluruh akun keuangan perusahaan.",
    add: "Tambah Akun",
    count: "{count} akun",
    balance: "Saldo",
    status: "Status",
  ...
  categories: {
    title: "Kategori",
    subtitle: "Kelola kategori transaksi keuangan perusahaan.",
    add: "Tambah Kategori",
  ...
  budgets: {
    title: "Anggaran",
    subtitle: "Kelola anggaran bulanan per kategori pengeluaran.",
    add: "Tambah Anggaran",
  ...
  savingGoals: {
    ...
    subtitle: "Kelola target tabungan dan pantau progres pencapaiannya.",
    add: "Tambah Target",
    count: "{count} target",
    target: "Target",
    collected: "Terkumpul",
