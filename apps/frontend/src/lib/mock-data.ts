...
export const recentTransactions: TransactionItem[] = [
  { id: "txn-001", date: "2026-08-04", category: "Gaji", description: "Gaji bulanan", amount: 15200000, type: "income", status: "completed" },
  { id: "txn-002", date: "2026-08-04", category: "Belanja", description: "Belanja bulanan", amount: 2850000, type: "expense", status: "completed" },
  { id: "txn-003", date: "2026-08-03", category: "Utilitas", description: "Tagihan listrik", amount: 780000, type: "expense", status: "pending" },
  { id: "txn-004", date: "2026-08-03", category: "Transportasi", description: "Isi bensin", amount: 350000, type: "expense", status: "completed" },
  { id: "txn-005", date: "2026-08-02", category: "Freelance", description: "Proyek desain", amount: 4200000, type: "income", status: "completed" },
  { id: "txn-006", date: "2026-08-02", category: "Perumahan", description: "Sewa apartemen", amount: 4500000, type: "expense", status: "completed" },
  { id: "txn-007", date: "2026-08-01", category: "Tabungan", description: "Transfer ke tabungan", amount: 3000000, type: "expense", status: "cancelled" },
  { id: "txn-008", date: "2026-07-31", category: "Gaya Hidup", description: "Langganan streaming", amount: 149000, type: "expense", status: "pending" },
  { id: "txn-009", date: "2026-07-30", category: "Kesehatan", description: "Asuransi kesehatan", amount: 620000, type: "expense", status: "completed" },
  { id: "txn-010", date: "2026-07-29", category: "Investasi", description: "Beli reksa dana", amount: 1500000, type: "expense", status: "completed" },
  { id: "txn-011", date: "2026-07-28", category: "Bisnis", description: "Penjualan online", amount: 2340000, type: "income", status: "pending" },
  { id: "txn-012", date: "2026-07-28", category: "Transportasi", description: "Tiket kereta", amount: 480000, type: "expense", status: "cancelled" },
  { id: "txn-013", date: "2026-07-27", category: "Makanan", description: "Makan siang tim", amount: 320000, type: "expense", status: "completed" },
  { id: "txn-014", date: "2026-07-26", category: "Gaji", description: "Bonus kinerja", amount: 3500000, type: "income", status: "completed" },
  { id: "txn-015", date: "2026-07-25", category: "Utilitas", description: "Tagihan internet", amount: 425000, type: "expense", status: "completed" },
  { id: "txn-016", date: "2026-07-24", category: "Belanja", description: "Belanja kebutuhan dapur", amount: 640000, type: "expense", status: "completed" },
  { id: "txn-017", date: "2026-07-23", category: "Investasi", description: "Beli obligasi negara", amount: 2000000, type: "expense", status: "cancelled" },
  { id: "txn-018", date: "2026-07-22", category: "Bisnis", description: "Penjualan merchandise", amount: 1875000, type: "income", status: "completed" },
];
