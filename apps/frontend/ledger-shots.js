...
(async () => {
  ...
  for (const code of ['IDR', 'USD', 'SGD', 'JPY']) {
    ...
    await page.click('aside a[href="/accounts"], nav a[href="/accounts"]');
    await page.waitForURL(/accounts/, { timeout: 15000 }).catch(() => {});
    await page.waitForTimeout(2000);
    await page.screenshot({ path: `./playwright-traces/ledger-${code}.png` });
    console.log(`saved ledger-${code}.png`);
  }
  await browser.close();
})();
