...
"[project]/apps/frontend/src/features/transactions/transactions-page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildCategoryTypes(categories) {
    const lookup = {};
...
function TransactionsPage() {
    ...
    const dataVersion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$stores$2f$refresh$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDataRefreshStore"])({
        "TransactionsPage.useDataRefreshStore[dataVersion]": (state)=>state.version
    }["TransactionsPage.useDataRefreshStore[dataVersion]"]);
    const bumpRefresh = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$stores$2f$refresh$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDataRefreshStore"])({
        "TransactionsPage.useDataRefreshStore[bumpRefresh]": (state)=>state.bump
    }["TransactionsPage.useDataRefreshStore[bumpRefresh]"]);
    const activeCurrency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$stores$2f$dashboardCurrency$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardCurrencyStore"])({
        "TransactionsPage.useDashboardCurrencyStore[activeCurrency]": (s)=>s.currency
    }["TransactionsPage.useDashboardCurrencyStore[activeCurrency]"]);
    const defaultFilters = (()=>{
        ...
        return {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$features$2f$transactions$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMPTY_FILTERS"],
    ...
    const urlQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])().get("q") ?? "";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            setFilters({
                "TransactionsPage.useEffect": (prev)=>({
                        ...defaultFilters,
                        search: urlQuery || prev.search
                    })
            }["TransactionsPage.useEffect"]);
            setPage(1);
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            ...
            void ({
                "TransactionsPage.useEffect": async ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            setPage(1);
            setRefreshKey({
                "TransactionsPage.useEffect": (k)=>k + 1
            }["TransactionsPage.useEffect"]);
        }
    }["TransactionsPage.useEffect"], [
        activeCurrency
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            const id = setTimeout({
                "TransactionsPage.useEffect.id": ()=>setSearch(filters.search.trim())
            }["TransactionsPage.useEffect.id"], SEARCH_DEBOUNCE_MS);
            return ({
                "TransactionsPage.useEffect": ()=>clearTimeout(id)
            })["TransactionsPage.useEffect"];
        }
    }["TransactionsPage.useEffect"], [
        filters.search
    ...
    const queryConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[queryConfig]": ()=>{
            return {
                ...
                type: filters.type === "all" ? undefined : filters.type === "income" ? "INCOME" : "EXPENSE",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            ...
            const run = {
                "TransactionsPage.useEffect.run": async ()=>{
                    ...
                    setError(false);
                    try {
                        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$services$2f$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transactionService"].list(params);
                        if (cancelled) {
                            return;
                        }
                        setTransactions(result.data.map({
                            "TransactionsPage.useEffect.run": (dto)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$services$2f$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTransactionItem"])(dto, accountNames, categoryNames, accountCurrencies)
                        }["TransactionsPage.useEffect.run"]));
    ...
    const categoryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[categoryOptions]": ()=>[
                ...new Set(Object.values(categoryNames))
            ].sort()
    }["TransactionsPage.useMemo[categoryOptions]"], [
        categoryNames
    ]);
    const categoryGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[categoryGroups]": ()=>{
            const income = [];
            const expense = [];
            ...
            return [
                ...
                ...expense.length ? [
                    {
                        label: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$locales$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uiText"].transactions.typeExpense,
                        items: expense
                    }
                ] : []
            ];
    ...
    const accountOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[accountOptions]": ()=>[
    ...
    const accountCurrencyByName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[accountCurrencyByName]": ()=>{
            const map = {};
    ...
    const openForm = (mode, transaction)=>{
        setFormState((state)=>({
                open: true,
                mode,
                transaction,
    ...
    const handleFormSubmit = async (values)=>{
        if (formState.mode === "edit" && formState.transaction) {
            const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$services$2f$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUpdateTransactionPayload"])(values, accountNames, categoryNames, accountCurrencies);
            if (payload) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$lib$2f$offline$2f$sync$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncUpdateTransaction"])(formState.transaction.id, payload);
                } catch  {
        ...
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$services$2f$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toCreateTransactionPayload"])(values, accountNames, categoryNames, accountCurrencies);
        if (payload) {
            try {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$locales$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uiText"].transactions.title
                    }, void 0, false, {
                        fileName: "[project]/apps/frontend/src/features/transactions/transactions-page.tsx",
                        lineNumber: 431,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-1 text-sm text-muted-foreground",
                        children: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$frontend$2f$src$2f$locales$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uiText"].transactions.subtitle
                    }, void 0, false, {
                        fileName: "[project]/apps/frontend/src/features/transactions/transactions-page.tsx",
                        lineNumber: 434,
                        columnNumber: 9
...
_s(TransactionsPage, "9pB1vAR0S6VPjyq9dzZXp1wenO0=", false, function() {
    return [
...
//# sourceMappingURL=apps_frontend_src_0-4mro4._.js.map