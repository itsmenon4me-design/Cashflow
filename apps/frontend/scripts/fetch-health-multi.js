(async () => {
  try {
    ...
    const API_BASE = process.env.API_BASE || 'http://127.0.0.1:3003/api/v1';
    ...
    for (const currency of currencies) {
      ...
      console.log('OVERVIEW:', JSON.stringify(overview.json, null, 2));
      console.log('EXPENSES:', JSON.stringify(expenses.json, null, 2));
